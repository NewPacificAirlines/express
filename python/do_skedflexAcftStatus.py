...
def run_query(start_date, end_date):
    ...
    try:
        ...
        while index < len(statusTailNum):
            ...
            statusByTailNum['Aircraft'] = statusTailNum[index]
            statusByTailNum['Type'] = statusType[index]
            statusByTailNum['Status'] = statusCurrent[index]
            statusByTailNum['Note'] = statusNote[index]
            statusByTailNum['Date'] = statusDate[index]
        ...
        #print(jsonOutput)
        print(json.dumps(statusByTailNum))
